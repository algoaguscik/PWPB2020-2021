...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Latihan Intent Parcelable");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Algo Aguscik");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("M Algo Aguscik");
                mPerson.setEmail("1819117583.siswa@smkn4bdg.sch.id");
                mPerson.setAge(17);
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "082128459602";
